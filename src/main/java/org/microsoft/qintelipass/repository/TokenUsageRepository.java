...
public interface TokenUsageRepository extends JpaRepository<TokenUsage, Long> {
     ...
     */
    Optional<TokenUsage> findByUserIdAndUsageDateAndModel(Long userId, LocalDate date, String model);
    ...
    @Query("""
            ...
            WHERE t.userId = :userId
              AND t.usageDate BETWEEN :start AND :end
